        ...
        switch (opc) {
            case 1: Verify_admin();
            {
                if (check_admin == 1)
                    ...
                    if (check_admin == 0)
                    cout << "HA EXCEDIDO EL LIMITE DE INTENTOS\n";
                break;
            }
                break;
            ...
            case 3:
            {
                if (check_sell == 1) {
                    ...
                    cout << setw(30) << "ABARROTES DON TILIN\n";
...
void Altas() {
    ...
    while (true) {
        ...
        if (pos == -1) {
            ...
            i = i_b;
            while (true) {
                cout << "EL PRODUCTO " << nombre << " ESTA DADO DE BAJA, ¿DESEA DARLO DE ALTA?\n";
                cout << "1. SI\n";
                cout << "2. NO\n";
                cin >> opc;
                switch (opc) {
